...
for i, row in enumerate(rows):
    ...
    try:
        ...
        # Gender sıfırlama yapma — gereksiz LoadFile'ı tetikler.
        # Bozuk state varsa bir sonraki LoadFile zaten düzeltir.

    finally:
        # Native nesneleri Python tarafında hemen bırak; CC5 heap baskısını azaltır.
        try:
            del shaping, avatar
        except NameError:
            pass
        # Her 500 karakterde Python GC'yi zorla
