...
FBX_DIR      = str(_ROOT / "fbx_export_height_sensitivity")
META_TMP_DIR = str(_ROOT / "logs" / "height_sensitivity_meta")
OUT_CSV      = str(_ROOT / "logs" / "height_sensitivity_measurements.csv")
POLL_SEC     = 10
